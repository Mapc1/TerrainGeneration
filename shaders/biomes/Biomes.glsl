...
const float biomes_limits[BIOME_LUT_MAX][BIOME_LUT_SQUARE_MAX][10] = {
    ...
    */
    ...
    {
        {-1,0.3, -1,1, -0.2,1, 0,1, -0.1,0.25}, {-2,0, 0,0, 0,0, 0,0, 0,0} // FOREST
    },
    {
        {-1,0.3, -1,1, -0.2,1, -1,0, 0.25,1}, {-2,0, 0,0, 0,0, 0,0, 0,0}// DESERT
    },
    {
        {-1,0.3, -1,1, -1,-0.2, -1,1, -1,1}, {-2,0, 0,0, 0,0, 0,0, 0,0} // PLATEAU
    },
    {
        {-1,0.3, -1,1, -0.2,1, -1,1, -1,-0.1}, {-2,0, 0,0, 0,0, 0,0, 0,0} // SNOW_PLAINS
    },
    {
        {-1,0.3, -1,1, -0.2,1, 0,1, 0.25,1}, {-2,0, 0,0, 0,0, 0,0, 0,0} // JUNGLE
    },
    {
        {-1,0.3, -1,1, -0.2,1, -1,0, -0.1,0.25},  {-2,1, -1,1, -1,1, -1,1, -1,1} // PLAIN 
    },
};
